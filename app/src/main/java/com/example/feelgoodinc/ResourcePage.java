...
public class ResourcePage extends AppCompatActivity implements NavigationBarView.OnItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId() == R.id.tutorialButton) {
            Intent intent = new Intent(ResourcePage.this, TutorialActivity.class);
